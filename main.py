...
font = pygame.font.Font('assets/font/manga.ttf',26)
big_font = pygame.font.Font('assets/font/manga.ttf',69)
WIDTH = 900
HEIGHT = 800
...
def draw_score() :
    ...
    screen.blit(points_text,(320,665))
    shots_text = font.render(f'Total Shots: {total_shots}', True, 'black')
    screen.blit(shots_text,(320,690))
...
def draw_menu() :
    global game_over, pause, mode, level, menu, time_passed, total_shots, points, ammo, time_remaining, clicked, best_time
    global best_ammo, best_freeplay, write_values, new_coords
    game_over = False
    pause = False
    ...
    screen.blit(font.render(f'{best_freeplay}',True,'black'),(335,585))
    ammo_button = pygame.rect.Rect((475,524), (260, 100))
    screen.blit(font.render(f'{best_ammo}',True,'black'),(650,585))
    timed_button = pygame.rect.Rect((170,661), (260, 100))
    screen.blit(font.render(f'{best_time}',True,'black'),(350,715))
